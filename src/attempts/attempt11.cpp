...
struct sat_solver {
    ...
    sat_solver(sat_problem &_sat_data, visitations &_visited) : sat_data(_sat_data), visited(_visited) {
        // random generation
    ...
    std::string restart(bitset &assignment) {
        ...
        // that thinking shows why luby restarts aren't working well
        // the way that visitations work, it doesn't actually work that well...

        // why can't we just add in all the clauses... negated... 
        // strange thoughts here... 

        // maybe we take a detour on this and start looking at vsids... 
        // what is life and stuff in this place... 




        // what's performance look like after removing visitations??
        // is there even a point of doing visitations right now???
            // maybe when we do random restarts and parallelization...
            // maybe doing things in parallel will really start making improvements...
            // start vsids, then look at cdcl, then start parllelizing the code....

            // for some reason the visitations does make a difference... maybe because I do random assignments... 
            // that's where it's doing stuf... 





        // C208_120 unsat should be easy to solve??? why can't I solve it???
        // there are so many unit clauses at the start...
        // shouldn't this be really fast???


        // maybe I should keep track of the number of satisfied clauses per assignment...
        // see that this number keeps on going down??? not really that sure though...

        // maybe there's something wrong with unit propagation... this should be so fast but it's actually really slow... 
        // why is that???

        // maybe because it's only doing things randomly... 
        // using vsids should help out with this...
        // even just keeping track of the number of occurrences of a variable might actually just help...
        ...
        // luby stats
            // C1065_064 -- unsat 157.42s  4.26245e+06

            // C181_3151 -- sat   3.92369s 197310
        ...
        // no luby stats
            //     C1065_064 -- unsat 37.5498s   1.06321e+06
            // new C1065_064 -- unsat 29.9132s   848403
            //     C1065_082 -- unsat 34.084s    974621
            // new C1065_082 -- unsat 33.3093s   960011

            // new C140 ------- sat   0.0139786s 1
            //     C175_145 --- unknown
            // new C181_3151 -- sat   2.67852s   135550
            // new C459_4675 -- sat   0.14574s   761
            // new C1597_024 -- 
...
int main(int argc, char* argv[]) {
    ...
    sat_solver sat_solver(sat_data, visisted);
