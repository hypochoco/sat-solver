...
// we're starting to run out of memory, so some things are going to be allocated onto the heap
...
struct sat_solver {
    ...
    // notes
        // takes as input a visitation that can be updated...
        // current solve depth or something for luby restarts... 
        // store anything else that might be useful to keep track of...
